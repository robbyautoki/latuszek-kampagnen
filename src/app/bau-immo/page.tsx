...
export default function BauImmoPage() {
  return (
      ...
      <main className="max-w-5xl mx-auto px-6 sm:px-8">
        ...
        <AnimatedSection animation="fade">
          <section className="text-center pt-40 pb-24 sm:pt-48 sm:pb-32">
            <p className="text-[#86868b] text-sm font-medium uppercase tracking-widest mb-6">
              Bau &amp; Immobilien &middot; 887 Kontakte
            </p>
            ...
            <p className="text-[#86868b] max-w-2xl mx-auto text-lg sm:text-xl leading-relaxed mt-6">
              3 optimierte Kampagnen mit je 3 E-Mails f&uuml;r GmbH-Gesch&auml;ftsf&uuml;hrer
              im Bau- und Immobiliensegment. Datenbasiert optimiert f&uuml;r maximale Response Rate.
            </p>
          </section>
        </AnimatedSection>
        ...
        <section className="text-center py-24">
          <p className="text-sm text-[#86868b] leading-relaxed">
            Zielgruppe: GmbH-Gesch&auml;ftsf&uuml;hrer (Bau &amp; Immobilien) &middot; CTA: Antwort auf E-Mail
          </p>
          <div className="flex flex-wrap items-center justify-center gap-2 mt-4">
            {["Anrede", "Nachname", "Vorname", "Firmenname", "Kerngeschaeft"].map(
              (p) => (
                <code
                  key={p}
